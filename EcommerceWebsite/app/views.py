...
def mobiles (request, data=None):
 ...
 if data == None:
  mobiles = Product.objects.filter(category='M')
 elif data == 'samsung' or data == 'iphone' or data == 'blackberry':
...
def laptops (request, data=None):
 if data == None:
  laptops = Product.objects.filter(category='L')
 elif data == 'hp' or data == 'game' or data=='apple':
...
class CustomerRegistrationView(View):
 ...
 def post(self, request):
  ...
  if form.is_valid():
   messages.success(request, 'Congratulations!! Registrered Successfully')
   form.save()
...
class ProfileView(View):
 ...
 def post(self, request):
  ...
  if form.is_valid():
   ...
   reg.save()
   return redirect('/profile', messages.success(request, 'Congratulations!! Profile Update Successfully'))
  return render(request, 'app/profile.html', {'form':form, 'active':'btn-primary'})